/* org.agiso.tempel.engine.EclipseProjectGeneralTemplateITest (18-01-2014)
 * 
 * EclipseProjectGeneralTemplateITest.java
 * 
...
/**
 * Testy integracyjne szablonu <code>eclipse.project.general</code>.
 * </br>
...
//	--------------------------------------------------------------------------
	public EclipseProjectGeneralTemplateITest() {
...
//	--------------------------------------------------------------------------
	...
	public void testTemplateInvocation() throws Exception {
		...
		assert "24b0f01c5121bd4c267dd375b2f957a4".equals(md5) : md5;
	}
	...
	public void testReferenceTemplateInvocation_02() throws Exception {
		...
		String md5 = DigestUtils.countDigest("MD5", new File(outPath));
		assert "378b51c6a6b0296f8d1fb6f38bed3e06".equals(md5) : md5;
	}
}
