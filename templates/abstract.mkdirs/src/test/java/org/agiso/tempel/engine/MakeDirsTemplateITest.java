/* org.agiso.tempel.engine.MakeDirsTemplateITest (18-01-2014)
 * 
...
/**
 * Testy integracyjne szablonu <code>abstract.mkdirs</code>.
 * </br>
 ...
 */
public class MakeDirsTemplateITest extends AbstractTemplateTest {
	private static final String GROUP_ID    = "org.agiso.tempel.templates";
	private static final String TEMPLATE_ID = "abstract.mkdirs";
	private static final String VERSION     = "1.0.0";

//	--------------------------------------------------------------------------
	public MakeDirsTemplateITest() {
		super(GROUP_ID, TEMPLATE_ID, VERSION);
	}

//	--------------------------------------------------------------------------
	/**
	 * Test bezpośredniego wywołania szablonu <code>abstract.mkdirs</code>.
	 * </br>
	...
	public void testAbstractTemplateInvocation() throws Exception {
		...
		// Próba wykonania szablonu abstrakcyjnego 'abstract.mkdirs':
	...
	/**
	 * Test wywołania szablonu z ręcznie podpiętym silnikiem {@link MakeDirsEngine}
	...
	public void testEngineInvocation_02() throws Exception {
		...
		tempel.setParamReader(paramReader);
		tempel.startTemplate(
				"org.agiso.tempel.engine:MakeDirsTemplateITest:testEngineInvocation_02",
				new HashMap<String, String>(), new File(outPath).getCanonicalPath()
		);
	...
	/**
	 * Test wywołania szablonu <code>abstract.mkdirs</code> z szablonu testowego
	...
	public void testReferenceTemplateInvocation_02() throws Exception {
		...
		tempel.setParamReader(paramReader);
		tempel.startTemplate(
				"org.agiso.tempel.engine:MakeDirsTemplateITest:testReferenceTemplateInvocation_02",
				new HashMap<String, String>(), new File(outPath).getCanonicalPath()
		);
